...
analyzeWithAI('Cek pengajuan sewa', { properties: [{ title: 'Kost Madani' }], stats: { unreadMessages: 15, pendingBookings: 1, pendingSurveys: 0 }, userName: 'Mitra', pendingBookingsList: [{ id: 'b297...', amount: 400000, user: { name: 'zhull' }, metadata: { kostName: 'Kost Madani' } }] }).then(console.log).catch(console.error); 
