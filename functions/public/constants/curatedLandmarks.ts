 ...
 * Mencakup 25 kota/kawasan strategis di Indonesia.
 */
...
export const CURATED_LANDMARKS: CuratedLandmark[] = [
    ...
    { id: 'jkt-rs-silom-kebon-jeruk', name: 'Siloam Hospitals Kebon Jeruk / Lippo', category: 'hospital', city: 'Jakarta Barat', province: 'DKI Jakarta', lat: -6.191512, lng: 106.765501, aliases: ['siloam kebon jeruk'] },
    ...
    { id: 'jkt-stasiun-mrt-dukuh-atas', name: 'Transit Hub MRT / LRT / KRL Dukuh Atas', category: 'transport', city: 'Jakarta Pusat', province: 'DKI Jakarta', lat: -6.201512, lng: 106.822501, aliases: ['dukuh atas', 'mrt dukuh atas'] },

    // ══════════════════════════════════════════════════════════════════════════════
    // 3. BANDUNG RAYA & JATINANGOR (JAWA BARAT)
    // ══════════════════════════════════════════════════════════════════════════════
    // Kampus
    ...
    // ══════════════════════════════════════════════════════════════════════════════
    // 6. SEMARANG, SOLO, & PURWOKERTO (JAWA TENGAH)
    // ══════════════════════════════════════════════════════════════════════════════
    ...
    // ══════════════════════════════════════════════════════════════════════════════
    // 7. MEDAN, PALEMBANG, PADANG, PEKANBARU, LAMPUNG, BATAM (SUMATERA)
    // ══════════════════════════════════════════════════════════════════════════════
    ...
    // ══════════════════════════════════════════════════════════════════════════════
    // 8. BALI (DENPASAR, BADUNG, JIMBARAN, KUTA, CANGGU)
    // ══════════════════════════════════════════════════════════════════════════════
    ...
    // ══════════════════════════════════════════════════════════════════════════════
    // 9. KALIMANTAN (BALIKPAPAN/IKN, SAMARINDA, BANJARMASIN, PONTIANAK) & MANADO
    // ══════════════════════════════════════════════════════════════════════════════
