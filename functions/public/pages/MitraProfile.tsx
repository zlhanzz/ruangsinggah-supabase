...
const MitraProfile: React.FC<MitraProfileProps> = ({ 
    ...
    const handleStep1Submit = async () => {
        ...
        if (!formData.phone || formData.phone.trim() === '') {
            ...
            waSectionRef.current?.focus?.();
            return;
        }
        if (!waOtpVerified && !initialUser?.whatsapp_verified) {
            setHighlightWaCard(true);
            setTimeout(() => setHighlightWaCard(false), 2000);
            waSectionRef.current?.scrollIntoView({ behavior: 'smooth', block: 'center' });
            alert('Nomor WhatsApp wajib diverifikasi dengan kode OTP sebelum melanjutkan ke Langkah 2.');
            return;
        }
    ...
    const handleInitiateChangePhone = () => {
        if (waOtpVerified) {
            const confirmChange = window.confirm(
                'Apakah Anda yakin ingin mengganti nomor WhatsApp? Nomor yang baru wajib diverifikasi ulang dengan kode OTP.'
            );
                            ...
                            {currentStep === 1 ? (
                                <div>
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                        ...
                                        <div className={formData.verification_status === 'verified' && phoneEditStep !== 'none' ? 'md:col-span-2' : ''}>
                                            {formData.verification_status === 'verified' ? (
                                                <div className="space-y-2">
                                                    <div className="flex items-center justify-between">
                                                        ...
                                                        {waOtpVerified && (
                                                            <span className="flex items-center gap-1 text-[9px] font-black uppercase text-green-600 bg-green-50 px-2 py-0.5 rounded-md border border-green-100">
                                                    ...
                                                    {phoneEditStep === 'none' ? (
                                                        <div className="flex items-center justify-between p-4 bg-gray-50 border border-gray-200 rounded-2xl">
                                                            ...
                                                            <button 
                                                                ...
                                                                className="text-[10px] font-black uppercase tracking-widest text-orange-500 hover:underline cursor-pointer"
                                                            >
                                                                Ubah
                                                            </button>
                                                        </div>
                                                        ...
                                                        <div className="space-y-3">
                                                            ...
                                                            <div className="p-4 bg-orange-50/50 rounded-2xl border border-orange-100 space-y-3 text-center">
                                                                <div className="flex items-center justify-between">
                                                                    ...
                                                                    {waResendTimer > 0 && securityOtpCode ? (
                                                                        ...
                                                                        <button type="button" onClick={handleSendSecurityOtp} className="text-[9px] font-black text-orange-500 hover:underline uppercase cursor-pointer">
                                                                            Kirim Ulang
                                                                        </button>
                                                                    ) : null}
                                                                </div>
                                                                ...
                                                                <div className="flex justify-center gap-1.5 sm:gap-2">
                                                                    {securityOtpDigits.map((digit, idx) => (
                                                                        <input
                                                                            ...
                                                                            className="w-9 sm:w-10 h-11 sm:h-12 text-center font-mono font-bold text-lg bg-white border border-gray-200 rounded-xl focus:border-orange-500 outline-none transition-all shadow-xs"
                                                                        />
                                                                    ))}
                                                                </div>
                                                                ...
                                                                <button 
                                                                    ...
                                                                    className="w-full py-2.5 bg-orange-500 hover:bg-orange-600 disabled:bg-gray-200 disabled:text-gray-400 text-white font-bold text-xs rounded-xl active:scale-95 transition-all uppercase tracking-widest cursor-pointer shadow-sm"
                                                                >
                                                        ...
                                                        <div className="space-y-3">
                                                            ...
                                                            <div className="flex gap-2">
                                                                <button 
                                                                    ...
                                                                    className="w-1/3 py-2.5 bg-gray-100 hover:bg-gray-200 text-gray-600 font-bold text-xs rounded-xl transition-all uppercase tracking-widest cursor-pointer"
                                                                >
                                                                    Batal
                                                                </button>
                                                                <button 
                                                                    ...
                                                                    className="w-2/3 py-2.5 bg-orange-500 hover:bg-orange-600 text-white font-bold text-xs rounded-xl active:scale-95 transition-all uppercase tracking-widest cursor-pointer shadow-sm"
                                                                >
                                                                    Kirim OTP Baru
                                                                </button>
                                                            </div>
                                                        ...
                                                        <div className="p-4 bg-orange-50/50 rounded-2xl border border-orange-100 space-y-3 text-center">
                                                            <div className="flex items-center justify-between">
                                                                <span className="text-[10px] font-black text-orange-800 uppercase tracking-widest">Masukkan 6 Digit OTP ({tempPhone})</span>
                                                                {waResendTimer > 0 ? (
                                                                    <span className="text-[9px] font-bold text-gray-400 uppercase">Kirim ulang dalam {waResendTimer}s</span>
                                                                ) : (
                                                                    <button type="button" onClick={handleSendNewWaOtp} className="text-[9px] font-black text-orange-500 hover:underline uppercase cursor-pointer">
                                                                        Kirim Ulang
                                                                    </button>
                                                                )}
                                                            </div>
                                                            ...
                                                            <div className="flex gap-2">
                                                                ...
                                                                <button 
                                                                    ...
                                                                    className="w-2/3 py-2.5 bg-orange-500 hover:bg-orange-600 disabled:bg-gray-200 disabled:text-gray-400 text-white font-bold text-xs rounded-xl active:scale-95 transition-all uppercase tracking-widest cursor-pointer shadow-sm"
                                                                >
                                                                    Verifikasi OTP
                                                                </button>
                                                            </div>
                                                ...
                                                <div className="group">
                                                    <div className="flex items-center justify-between mb-2">
                                                        <div className="flex items-center gap-3 text-gray-400">
                                                            <div className="w-8 h-8 rounded-lg bg-gray-50 flex items-center justify-center text-gray-400 group-hover:text-orange-500 group-hover:bg-orange-50 transition-colors">
                                                                <Phone size={18} />
                                                            </div>
                                                            <p className="text-[10px] font-black uppercase tracking-widest leading-none text-gray-500">No. WhatsApp</p>
                                                        </div>
                                                    ...
                                                    {waOtpVerified ? (
                                                        <div className="relative flex items-center">
                                                            <input
                                                                ...
                                                                readOnly
                                                                className="w-full bg-green-50/20 border border-green-200 p-4 pr-24 rounded-2xl outline-none font-bold text-sm text-gray-900 cursor-not-allowed select-none"
                                                            />
                                                            <div className="absolute right-3 flex items-center gap-2">
                                                                ...
                                                                <button
                                                                    ...
                                                                    className="text-[10px] font-bold uppercase tracking-wider text-orange-600 hover:text-orange-700 bg-white hover:bg-orange-50 px-2.5 py-1 rounded-lg border border-orange-200 transition-all cursor-pointer"
                                                                >
                                                                    Ubah
                                                                </button>
                                                            </div>
                                                        ...
                                                        <div className="space-y-3">
                                                            <div className="relative flex items-center">
                                                                ...
                                                                {waOtpCode || isVerifyingWaOtp ? (
                                                                    <button
                                                                        type="button"
                                                                        onClick={handleInitiateChangePhone}
                                                                        className="absolute right-3 text-[10px] font-bold uppercase tracking-wider text-orange-600 hover:underline cursor-pointer"
                                                                    >
                                                                        Ganti
                                                                    </button>
                                                                ) : (
                                                                    <button
                                                                        ...
                                                                        className="absolute right-2 px-3 py-2 bg-orange-500 hover:bg-orange-600 disabled:opacity-50 text-white rounded-xl text-xs font-bold transition-all flex items-center gap-1.5 shadow-xs cursor-pointer active:scale-95"
                                                                    >
                                                                        {isSubmitting ? (
                                                            ...
                                                            {/* Compact OTP Input (hanya jika OTP aktif & belum terverifikasi) */}
                                                            {(waOtpCode || isVerifyingWaOtp) && (
                                                                <div className="p-3.5 bg-orange-50/50 border border-orange-200 rounded-2xl space-y-2.5 animate-in fade-in duration-200">
                                                                    <div className="flex items-center justify-between text-[10px]">
                                                                        <span className="font-bold text-orange-950 uppercase tracking-wider">
                                                                            Masukkan 6 Digit OTP
                                                                        </span>
                                                                        {waResendTimer > 0 ? (
                                                                            <span className="text-gray-400 font-bold">
                                                                                Kirim ulang ({waResendTimer}s)
                                                                            </span>
                                                                        ) : (
                                                                            <button
                                                                                type="button"
                                                                                ...
                                                                                className="font-bold text-orange-600 hover:underline uppercase cursor-pointer"
                                                                            >
                                                                                Kirim Ulang
                                                                            </button>
                                                                        )}
                                                                    ...
                                                                    <div className="flex items-center justify-center gap-1.5 sm:gap-2">
                                                                        {otpDigits.map((digit, idx) => (
                                                                            <input
                                                                                ...
                                                                                onKeyDown={e => handleOtpKeyDown(idx, e)}
                                                                                onPaste={handleOtpPaste}
                                                                                className="w-9 sm:w-10 h-11 sm:h-12 text-center font-mono font-bold text-lg bg-white border border-gray-300 rounded-xl focus:border-orange-500 focus:ring-1 focus:ring-orange-500 outline-none transition-all shadow-xs"
                                                                            />
                                                                        ))}
                                                                    </div>
                                                                    ...
                                                                    <button
                                                                        ...
                                                                        className="w-full py-2.5 bg-orange-500 hover:bg-orange-600 disabled:bg-gray-200 disabled:text-gray-400 text-white font-bold text-xs rounded-xl transition-all uppercase tracking-wider cursor-pointer active:scale-95 shadow-xs"
                                                                    >
                                ...
                                {currentStep === 1 ? (
                                    <>
                                        <button 
                                            type="button" 
                                            onClick={handleCancel} 
                                            className="w-full sm:w-auto px-8 py-3.5 bg-gray-100 text-gray-600 rounded-xl text-xs font-black uppercase tracking-widest hover:bg-gray-200 active:scale-95 transition-all text-center cursor-pointer"
                                        >
                                            BATAL
                                        </button>
                                        {formData.verification_status === 'verified' ? (
                                            <button 
                                                ...
                                                onClick={handleSave} 
                                                disabled={isSubmitting} 
                                                className="w-full sm:w-auto px-10 py-3.5 bg-orange-500 text-white rounded-xl text-xs font-black uppercase tracking-widest hover:bg-orange-600 active:scale-95 disabled:opacity-50 disabled:active:scale-100 transition-all shadow-lg shadow-orange-500/20 text-center cursor-pointer"
                                            >
                                            ...
                                            <button
                                                ...
                                                className="w-full sm:w-auto px-10 py-3.5 bg-orange-500 hover:bg-orange-600 text-white rounded-xl text-xs font-black uppercase tracking-widest transition-all text-center flex items-center justify-center gap-2 cursor-pointer shadow-lg shadow-orange-500/20 active:scale-95"
                                            >
