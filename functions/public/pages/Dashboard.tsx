...
const Dashboard: React.FC<DashboardProps> = ({ role, uid, user, onPageChange, onLogout, listings = [], onAdd, onEdit, onDelete, onRefreshListings, verificationStatus }) => {
    ...
    const loadProperties = async () => {
        ...
        setLoading(true);
        try {
            const data = await getAdminProperties(undefined);
            ...
            <div className="p-6 border-b border-gray-100">
                ...
                {isAdmin && (
                    <button
                        ...
                        className="mt-4 w-full bg-gray-900 text-white px-4 py-2.5 rounded-xl text-[10px] font-black uppercase tracking-widest hover:bg-orange-600 transition-all flex items-center justify-center gap-2 shadow-lg active:scale-95"
                    >
