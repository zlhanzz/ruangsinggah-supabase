            ...
            <div className="grid grid-cols-1 md:grid-cols-2">
              <div className="p-10 bg-gray-900 text-white flex flex-col justify-between">
                  ...
                  <div className="space-y-6">
                    <div className="flex items-start">
                      ...
                      <div>
                        ...
                        <p className="font-medium">+62 813-5632-6260</p>
                      </div>
                    </div>
                    <div className="flex items-start">
                      <div className="w-10 h-10 bg-orange-500/20 rounded-lg flex items-center justify-center text-orange-500 mr-4 shrink-0">
                      ...
                      <div>
                        ...
                        <p className="font-medium">bantuan@ruangsinggah.id</p>
                      </div>
                    </div>
                    <div className="flex items-start">
                      <div className="w-10 h-10 bg-orange-500/20 rounded-lg flex items-center justify-center text-orange-500 mr-4 shrink-0">
                      ...
                      <div>
                        ...
                        <p className="font-medium text-sm">Makassar, Sulawesi Selatan</p>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div className="mt-12 flex space-x-4">
                  <a href="https://www.instagram.com/ruangsinggahid" target="_blank" rel="noopener noreferrer" className="w-8 h-8 rounded-full border border-white/20 flex items-center justify-center hover:bg-white/10 transition-colors">
                  ...
                  <a href="https://www.tiktok.com/@cari.kost.makassa" target="_blank" rel="noopener noreferrer" className="w-8 h-8 rounded-full border border-white/20 flex items-center justify-center hover:bg-white/10 transition-colors">
                  ...
                  <a href="https://www.facebook.com/profile.php?id=61572134009904" target="_blank" rel="noopener noreferrer" className="w-8 h-8 rounded-full border border-white/20 flex items-center justify-center hover:bg-white/10 transition-colors">
                ...
                <form className="space-y-4" onSubmit={(e) => e.preventDefault()}>
                  ...
                  <div>
                    ...
                    <select className="w-full bg-gray-50 border border-gray-100 rounded-xl px-4 py-3 focus:outline-none focus:ring-2 focus:ring-orange-500/10 focus:border-orange-500 transition-all">
                      ...
                      <option>Jasa Survey Kost</option>
