...
import { updateAgentVerificationStatus } from '../../adminService';
                        ...
                        <div className="flex items-center gap-4 mb-4">
                            <div className="w-14 h-14 rounded-full bg-orange-100 flex items-center justify-center text-xl overflow-hidden border-2 border-orange-50">
                                {agent.photo_url || agent.agent_photo_url ? (
                                    <img src={agent.photo_url || agent.agent_photo_url} className="w-full h-full object-cover" />
                                ) : (
                                    <span>👤</span>
                                )}
                            </div>
        ...
        <div className="space-y-6">
            <div className="flex justify-between items-center mb-2">
                <div>
                    ...
                    <p className="text-gray-500 text-sm mt-1">Total {surveyAgents.length} agen aktif, {agentVerifications.length} menunggu verifikasi.</p>
                </div>
            </div>
