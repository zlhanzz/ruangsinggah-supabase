...
async function run() {
  const reqId = '3701f42f-53e8-4d71-8cfc-c49c2bff2a42';
  const agentId = '23ba3fa0-6ea0-43fd-aea7-4290c339e8a5';

  const kmSurveyPayload = {
    kostmanager_request_id: reqId,
    assigned_agent_id: agentId,
    status: 'PENDING_ASSIGNMENT',
    updated_at: new Date().toISOString()
  };

  console.log("Attempting insert into kostmanager_surveys...");
